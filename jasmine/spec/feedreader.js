...
$(function() {
    ...
    */
    ...
    /* This test suite named "The menu" is for testing the menu */
    describe('The menu', function() {
        ...
        it("The menu element is hidden by default", function() {
          ...
          */
        it("The menu element is hidden or showen after clicked", function() {
    ...
    describe('New Feed Selection', function() {
        ...
        beforeEach(function(done){
            loadFeed(0,function(){
                feed_1 = $('.feed .entry-link').html();
                loadFeed(1,function(){
                    feed_2 = $('.feed .entry-link').html();
                    done();
                });
            });            
        });
